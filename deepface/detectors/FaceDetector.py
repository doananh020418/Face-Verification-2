...
from deepface.detectors import OpenCvWrapper, SsdWrapper, DlibWrapper, MtcnnWrapper, RetinaFaceWrapper, FacenetWrapper
...
def build_model(detector_backend):
    ...
    backends = {
        ...
        'facenet': FacenetWrapper.build_model
    }
...
def detect_face(face_detector, detector_backend, img, align=True):
    backends = {
        ...
        'facenet' : FacenetWrapper.detect_face
    }
